...
// import { fetchLanguages, fetchVoiceLanguages, type Language } from "@/lib/api";
...
//     } catch {
//       setError(
//         "Failed to load languages. Please check your connection and try again.",
//       );
//     } finally {
//       setLoading(false);
//     }
...
//   if (error || !inputLang || !outputLang) {
//     return (
//       <div className="min-h-screen flex flex-col items-center justify-center gap-4 text-center px-4">
//         <p className="text-red-500 font-medium">
//           {error || "Languages could not be loaded."}
//         </p>
//         <button
//           onClick={() => {
//             setLoading(true);
