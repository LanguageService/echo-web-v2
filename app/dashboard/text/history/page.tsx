...
import { fetchTranslationHistory, toggleFavorite, type TranslationHistory, type GeneralVoiceTranslationHistory } from "@/lib/api";
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Translation History</h1>
      </div>

      {history.length === 0 ? (
        <div className="text-center py-12">
          <Clock className="w-16 h-16 mx-auto mb-4 text-gray-300 dark:text-gray-600" />
          <h3 className="text-lg font-semibold text-gray-600 dark:text-gray-400 mb-2">No translations yet</h3>
