  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/translations/document/base/`,
        {
          method: "POST",
    ...
    <div className="p-4 sm:p-6 space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          Upload a document and we'll translate it while preserving the
          formatting.
        </p>
      </div>
      ...
      {!result && (
        <div className="flex justify-center">
          <button
            ...
            className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-300 text-white px-8 py-3 rounded-full font-semibold transition"
          >
      ...
      {/* Result */}
      {result && status === "done" && (
        <div className="bg-white border border-[#b9ced5] rounded-2xl p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            {result.translated_file_url && (
              <a
                href={result.translated_file_url}
                download
                className="flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-full font-semibold transition"
              >
            ...
            <button
              onClick={resetPage}
              className="flex items-center justify-center gap-2 border border-gray-300 hover:bg-gray-50 text-gray-700 px-6 py-3 rounded-full font-semibold transition"
            >
